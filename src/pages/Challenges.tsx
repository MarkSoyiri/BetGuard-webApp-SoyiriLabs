...
import { Trophy, Plus, Check, Gift, Flame } from 'lucide-react';
...
export function Challenges() {
  ...
  const filtered = challenges.filter((c) => c.frequency === tab);
  ...
  const claim = (c: Challenge) => {
    ...
    toast(`Reward claimed — "${c.reward}" unlocked!`);
  };
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="flex size-11 items-center justify-center rounded-2xl bg-gradient-to-br from-secondary to-emerald-600 text-white shadow-lg shadow-secondary/25">
